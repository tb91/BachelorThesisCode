...
//		routingOnExit();
	...
	public static void write_routing_Record(final int density, final int numNodes, final double euclDistance,
			final double minEuclDis_UDG, final int minNumHops_UDG, final double minEuclDis_GG, final int minNumHops_GG,
			final double minEuclDis_PDT, final int minNumHops_PDT, final double euclDisFaceR_GG, final int hopsFaceR_GG,
			final double euclDisFaceR_PDT, final int hopsFaceR_PDT, final double euclDisGFG_GG, final int hopsGFG_GG,
		...
		// String filePathString = dateFormat.format(date) +
		// "-Record-routing-dist" + Math.round(euclDistance) + '-' + density +
		// '.' + fileExtension;
		String filePathString = dateFormat.format(date) + "-Record-routing-dist" + Math.round(euclDistance) + '.'
				+ fileExtension;
		OpenOption[] openOptions = new OpenOption[] { StandardOpenOption.CREATE, StandardOpenOption.APPEND };
		List<String> lines = new ArrayList<String>();
		lines.add(line.toString());
